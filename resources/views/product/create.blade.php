@extends('layouts.base', ['title' => 'Add Product'])

@section('meta_robots', 'noindex, nofollow')
@section('canonical', url('/product'))
...
@section('content')
    ...
    <section class="form-section">
        <div class="container">
            ...
            {{-- Success flash (shouldn't normally appear here, but just in case) --}}
            @if(session('success'))
            ...
            <div class="form-card">
                ...
                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <a href="{{ route('product.index') }}" class="cancel-link">
                            Cancel
                        </a>
                    </div>
                </form>
