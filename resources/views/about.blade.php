...
@section('meta_description', 'PT. Suryamas Elsindo Primatama established since 1996 as an electrical distributor and sole agent in Indonesia. Authorized agent for ABB, TE Connectivity, RITZ Transformer, GE Grid Solution, Elmeasure, OME Motors, and Hilkar.')

@section('og_title', 'About PT. Suryamas Elsindo Primatama — Electrical Distributor in Indonesia')
@section('og_description', 'Established in 1996, PT. Suryamas Elsindo Primatama is a trusted electrical distributor and sole agent in Indonesia. Serving industries, panel makers, and contractors.')
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="main-headding">
            ...
            <div class="hero-btns">
              <a href="{{ route('any', 'contact') }}" class="theme-btn2">Contact Us</a>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="headding2">
            ...
            <div class="space30"></div>
            <a href="{{ route('any', 'contact') }}" class="theme-btn2">Contact Us Now</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-5">
          <div class="about-page-boxs">
            <div class="single-box">
              ...
              <div class="headding2">
                <h3><a href="{{ route('any', 'product') }}">International Quality Products</a></h3>
            ...
            <div class="single-box">
              ...
              <div class="space20"></div>
              <div class="headding2">
                <h3><a href="{{ route('any', 'contact') }}">Free Technical Consultation</a></h3>
                <div class="space10"></div>
            ...
            <div class="single-box">
              ...
              <div class="space20"></div>
              <div class="headding2">
                <h3><a href="{{ route('any', 'contact') }}">Nationwide Distribution Network</a></h3>
                <div class="space10"></div>
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="headding2-w">
            ...
            <a href="{{ route('any', 'contact') }}" class="theme-btn3">Contact Us</a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="headding2">
            ...
            <div class="space20"></div>
            <a href="{{ route('any', 'product') }}" class="theme-btn2">View All Products</a>
          </div>
        </div>
      </div>
