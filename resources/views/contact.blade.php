@extends('layouts.base', ['title' => 'Contact Us'])

@section('meta_description', 'Contact PT. Suryamas Elsindo Primatama for electrical product inquiries, quotation requests, or technical consultation. Phone: (021) 585-5064. Email: suryamas@cbn.net.id. Located in West Jakarta.')

@section('og_title', 'Contact PT. Suryamas Elsindo Primatama — Electrical Distributor Jakarta')
@section('og_description', 'Reach out to us for electrical product needs, price quotations, and technical consultation. Phone: (021) 585-5064. Jl. Meruya Ilir Raya No.51, West Jakarta.')
...
<script type="application/ld+json">
{
  ...
  "breadcrumb": {
    ...
    "itemListElement": [
      ...
      {"@type": "ListItem", "position": 2, "name": "Contact Us", "item": "{{ url('/contact') }}"}
    ]
  }
}
</script>
        ...
        <div class="row align-items-center">
          <div class="col-lg-7">
            ...
            {{-- <div class="form-inputs">
              ...
              <p>Submit your inquiry, quotation request, or technical question below. Our team will respond within 1 business day.</p>

              <div class="space30"></div>
              <form action="{{ route('any', 'contact') }}" method="POST">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                    <div class="input">
                  ...
                  <div class="col-lg-12">
                    <div class="input">
                      <textarea cols="30" rows="4" name="message" placeholder="Your Message / Inquiry*" required></textarea>
                    </div>
                    <div class="button">
                      <button type="submit" class="theme-btn2">Send Message</button>
                    </div>
                  </div>
                </div>
              </form>
