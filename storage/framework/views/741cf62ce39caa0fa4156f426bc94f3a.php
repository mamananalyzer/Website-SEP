...
<?php $__env->startSection('canonical', url('/product/delete')); ?>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 sidebar-col">
                    <aside class="brand-sidebar">
                        ...
                        <a href="<?php echo e(route('product.delete')); ?>"
                        ...
                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <a href="<?php echo e(route('product.delete')); ?>?brand=<?php echo e($brandSlug); ?>"
                ...
                <div class="col-lg-9 content-col">
                        ...
                        <div class="empty-state">
                            ...
                            <p>
                                <?php if($selectedBrand): ?>
                                    No products match the brand "<strong><?php echo e(strtoupper($selectedBrand)); ?></strong>".
                                <?php else: ?>
                    ...
                    <?php else: ?>
                        ...
                        <form id="delete-form" action="<?php echo e(route('product.bulkDestroy')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="delete-toolbar">
                                <div class="selection-info">
                                    ...
                                    of <?php echo e($products->count()); ?> product<?php echo e($products->count() !== 1 ? 's' : ''); ?> selected
                                </div>
                            ...
                            <div class="product-list">
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="product-row" for="product-<?php echo e($product->id); ?>">
                                        <input type="checkbox"
                                        ...
                                        <div class="info">
                                            <span class="brand-badge"><?php echo e($product->brand); ?></span>
...
<?php echo $__env->make('layouts.base', ['title' => $pageTitle, 'metaTitle' => $pageTitle], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\+ Maman\Website SEP\esoftlaravel-10\esoftlaravel-10\Esoft-Laravel_v1.0\Esoft\resources\views/product/delete.blade.php ENDPATH**/ ?>