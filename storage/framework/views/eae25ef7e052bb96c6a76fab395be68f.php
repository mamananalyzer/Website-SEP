      ...
      <div class="col-lg-6 m-auto text-center">
        <div class="headding2-w pbmit-heading-subheading animation-style2">
          ...
          <div class="" data-aos="fade-up" data-aos-duration="1000">
            <a href="<?php echo e(route('second', ['auth', 'account'])); ?>" class="theme-btn3">Get Started For Free</a>
          </div>
        </div>
      </div>
    </div>
...
<!-- ===== CTA IMAGE AREA END ======= -->
<?php /**PATH F:\+ Maman\Website SEP\esoftlaravel-10\esoftlaravel-10\Esoft-Laravel_v1.0\Esoft\resources\views/layouts/partials/cta.blade.php ENDPATH**/ ?>